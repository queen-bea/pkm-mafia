...
const u8 gText_BirchBoy[] = _("OTHER");
const u8 gText_BirchGirl[] = _("GIRL");
const u8 gText_DefaultNameStu[] = _("ASH");
const u8 gText_DefaultNameMilton[] = _("GRAY");
const u8 gText_DefaultNameTom[] = _("ZEPHYR");
const u8 gText_DefaultNameKenny[] = _("AUGUST");
const u8 gText_DefaultNameReid[] = _("AVERY");
const u8 gText_DefaultNameJude[] = _("KAI");
const u8 gText_DefaultNameJaxson[] = _("QUINN");
const u8 gText_DefaultNameEaston[] = _("RILEY");
const u8 gText_DefaultNameWalker[] = _("RIVER");
const u8 gText_DefaultNameTeru[] = _("EMBER");
const u8 gText_DefaultNameJohnny[] = _("SAGE");
const u8 gText_DefaultNameBrett[] = _("JAMIE");
const u8 gText_DefaultNameSeth[] = _("REESE");
const u8 gText_DefaultNameTerry[] = _("ROBIN");
const u8 gText_DefaultNameCasey[] = _("CASEY");
const u8 gText_DefaultNameDarren[] = _("INDIGO");
const u8 gText_DefaultNameLandon[] = _("IVORY");
const u8 gText_DefaultNameCollin[] = _("RAY");
const u8 gText_DefaultNameStanley[] = _("NICKY");
const u8 gText_DefaultNameQuincy[] = _("ALEX");
const u8 gText_DefaultNameKimmy[] = _("BEA");
const u8 gText_DefaultNameTiara[] = _("AURORA");
const u8 gText_DefaultNameBella[] = _("LUNA");
const u8 gText_DefaultNameJayla[] = _("ZOEY");
const u8 gText_DefaultNameAllie[] = _("SKYE");
const u8 gText_DefaultNameLianna[] = _("VIOLET");
const u8 gText_DefaultNameSara[] = _("ALYSSA");
const u8 gText_DefaultNameMonica[] = _("ROSIE");
const u8 gText_DefaultNameCamila[] = _("JULIA");
const u8 gText_DefaultNameAubree[] = _("AUBREE");
const u8 gText_DefaultNameRuthie[] = _("ZINNIA");
const u8 gText_DefaultNameHazel[] = _("CLAIRE");
const u8 gText_DefaultNameNadine[] = _("IRIS");
const u8 gText_DefaultNameTanja[] = _("VIVIAN");
const u8 gText_DefaultNameYasmin[] = _("SOPHIA");
const u8 gText_DefaultNameNicola[] = _("AUTUMN");
const u8 gText_DefaultNameLillie[] = _("LILY");
const u8 gText_DefaultNameTerra[] = _("PENNY");
const u8 gText_DefaultNameLucy[] = _("APRIL");
const u8 gText_DefaultNameHalie[] = _("KAYLEE");
